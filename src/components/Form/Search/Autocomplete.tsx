...
interface Props {
	...
	selectAirport: (airport: any, segmentId: number, autocompleteType: AutocompleteFieldType) => any;
...
export default class Autocomplete extends React.Component<Props, State> {
	...
	selectOption(option: any): void {
		if (option && option.value && option.value.airport) {
			this.props.selectAirport(option.value.airport, this.props.segmentId, this.type);
		}
	}
