...
export default class Day extends React.PureComponent {
	...
	shouldComponentUpdate(nextProps) {
		return !this.props.day.isSame(nextProps.day) ||
			...
			// this.props.preSelection !== nextProps.preSelection ||
			// this.props.selected !== nextProps.selected ||
			// this.props.selectingDate !== nextProps.selectingDate ||
			// this.props.selectsEnd !== nextProps.selectsEnd ||
			// this.props.selectsStart !== nextProps.selectsStart ||
